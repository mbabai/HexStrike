...
- Throw interactions are tagged from card text (`throw` keyword in active/passive text, including passive `activeText`); combo prompts only open on non-throw hits.
